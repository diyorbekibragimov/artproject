  ...
  return (
    <div className="h-min-full h-full min-h-dvh bg-black">
      <header className="w-full relative flex flex-col justify-between py-5 text-center text-white">
        ...
        <div className="start w-full z-10 flex flex-row justify-between px-20">
          ...
          <div className="w-2/5 m-auto">
            <nav className="flex justify-end mr-4 uppercase tracking-wider">
              <a href="#" className="hover:underline mr-20">
                Home
              </a>
              <a href="#" className="hover:underline mr-20">
                Submit
              </a>
              <a href="#" className="hover:underline mr-10">
                About Us
              </a>
            </nav>
          </div>
      ...
      {/* <main className="flex flex-col items-center w-full flex-1 px-20 text-center">
        <div className="mt-6 flex max-w-4xl flex-wrap items-center justify-around sm:w-full">
          <div className="p-6 mt-6 text-left border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600">
            <h3 className="text-2xl font-bold">Submit &rarr;</h3>
          ...
          <div className="p-6 mt-6 text-left border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600">
            <h3 className="text-2xl font-bold">About Gallery &rarr;</h3>
            <p className="mt-4 text-xl">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row border-white font-extra-condensed text-white px-10">
            ...
            <div className="w-[60%] pb-24 font-normal font-body tracking-wide px-10">
              <p className="mt-5 text-2xl cursor-pointer font-extra-condensed hover:underline">
                <a className="">click here to start online gallery</a>
              </p>
            </div>
          </div>
        </div>
