...
const AboutUs = () => (
  <div className="text-white relative h-min-full h-full min-h-dvh bg-black">
    ...
    <div className="container mx-auto py-12">
      <div className="flex mt-14 flex-wrap items-center justify-start md:border-l-2 pl-10 pt-20 border-white">
        <div className="w-full md:w-3/5 z-10">
            <div className="font-title">
          <h2 className="text-8xl font-bold mb-2">About</h2>
          <h2 className="text-white text-8xl font-bold mb-2">Us</h2>
            </div>
    ...
    <div className="absolute top-0 right-0 w-1/2 blur-sm h-full">
      {/* Image */}
      <div
        style={{
          zIndex: "20",
