      ...
      <div className="flex-col relative md:flex-row flex w-full items-center">
        ...
        <div className="w-full p-10 md:p-0 md:w-3/5">
          ...
          <p className="text-white text-xl mt-2 text-title md:px-30">
            ...
            College London in 2007. He earned a PhD in English Literature at the
            Universiti Putra Malaysia in 2017 with a dissertation on John Donne.
            He taught literature and creative writing at the Islamic University
            ...
            the power of storytelling as a means of Palestinian resistance.
            (Wikipedia) One of his students, Lina Alsharif, emphasized that “His
            support to his students, especially me, was continuous. He believed
            in my lousy poems, he even taught one [of] them. He believed in all
            of his students.”
          </p>
        </div>
      </div>
