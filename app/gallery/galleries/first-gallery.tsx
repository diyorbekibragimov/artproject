        ...
        <div className="w-full md:w-1/3 md:block hidden">
          <div className="transform flex flex-row-reverse justify-center rotate-180 text-center">
            ...
            <div
              ...
              className="text-white bg-black text-5xl fond-bold uppercase tracking-wider font-extra-condensed"
            >
              mohammed sami
            </div>
            <div
              style={{ writingMode: "vertical-lr" }}
              className="text-white bg-black text-3xl capitalize tracking-widest font-semibold font-title"
            >
              Art Work
            </div>
          </div>
        </div>
        <div className="w-full md:w-1/3 text-center flex flex-col p-2 md:p-10">
          <Image
            src="/first-1.jpg"
            alt=""
            className="my-1"
            ...
            objectFit="cover"
          />
          <div className="text-white text-normal font-bold mt-4">
